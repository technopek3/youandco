            ...
            <div  class="box relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
              ...
              <div class="mt-5 flex-1 h-0 overflow-y-auto">
                <nav class="px-2">
                  ...
                  <a class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium text-gray-600over:text-gray-900  focus:outline-none focus:text-gray-900 transition ease-in-out duration-150 focus:bg-orange-200 hover:bg-orange-100 active:orange-200"  href="{{route('settings.edit')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-4 text-gray-400 " fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="2">
