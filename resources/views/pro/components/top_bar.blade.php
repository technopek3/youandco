            ...
            <div class="ml-3 z-10 relative">
                ...
                <div class="profile-menu hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">
                    <div class="py-1 rounded-md bg-white shadow-xs" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                        <a class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition ease-in-out duration-150" href="{{route('profile.edit')}}" role="menuitem">Mon profil</a>
                        <a class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition ease-in-out duration-150" href="{{route('settings.edit')}}" role="menuitem">Paramètres</a>
